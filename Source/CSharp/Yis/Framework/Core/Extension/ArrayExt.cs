...
namespace Yis.Framework.Core.Extension
{
    ...
    public static class ArrayExt
    {
        ...
        /// <returns></returns>
        /// <remarks>
        /// Test results prove that Array.Copy is many times faster than Skip/Take and LINQ Item
        /// count: 1,000,000 Array.Copy: 15 ms Skip/Take: 42,464 ms - 42.5 seconds
        /// LINQ: 881 ms
        /// 
        ...
        /// <summary> To clear the contents of the array. </summary> <typeparam name="T">The type of
        /// array</typeparam> <param name="clear"> The array to clear</param> <returns>Cleared
        /// array</returns> <example> <code> int[] result = new[] { 1, 2, 3, 4 }.ClearAll<int>();
        /// </code> </example> <remarks> Contributed by Mohammad Rahman,
        /// http://mohammad-rahman.blogspot.com/ </remarks>
        ...
        /// <summary> To clear a specific item in the array. </summary> <typeparam name="T">The type
        /// of array</typeparam> <param name="arrayToClear">Array to clear.</param> <param
        /// name="at">Which element to clear.</param> <returns></returns> <example> <code> string[]
        /// clearString = new[] { "A" }.ClearAt<string>(0); </code> </example> <remarks> Contributed
        /// by Mohammad Rahman, http://mohammad-rahman.blogspot.com/ </remarks>
        ...
        /// <summary> Combine two arrays into one. </summary> <typeparam name="T">Type of
        /// Array</typeparam> <param name="combineWith">Base array in which arrayToCombine will
        /// add.</param> <param name="arrayToCombine">Array to combine with Base array.</param>
        /// <returns></returns> <example> <code> int[] arrayOne = new[] { 1, 2, 3, 4 }; int[]
        /// arrayTwo = new[] { 5, 6, 7, 8 }; Array combinedArray =
        /// arrayOne.CombineArray<int>(arrayTwo); </code> </example> <remarks> Contributed by
        /// Mohammad Rahman, http://mohammad-rahman.blogspot.com/ </remarks>
